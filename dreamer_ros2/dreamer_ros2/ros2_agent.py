...
DREAMER_NODE_ROOT = "/sim_ws/src/uci_f1tenth_workshop/dreamer_node"
DREAMER_PKG_ROOT = f"{DREAMER_NODE_ROOT}/dreamer"

sys.path.extend([DREAMER_NODE_ROOT, DREAMER_PKG_ROOT])
